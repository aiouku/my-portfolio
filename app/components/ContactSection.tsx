            ...
            <div className="mx-auto max-w-6xl px-6">
                <div className="grid gap-12 lg:grid-cols-5">
                    ...
                    <div className={`lg:col-span-2 transition-all duration-700 delay-200 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-8 opacity-0"}`}>
                        <h3 className="mb-6 text-xl font-semibold">{t.contact.contactInfo}</h3>
                        <div className="space-y-4">
                            {contactMethods.map((method, index) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="text-sm text-zinc-500">{method.labelKey}</div>
                        ...
                        <div className="mt-8 glass-card rounded-2xl p-6">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-zinc-300">{t.contact.available}</span>
                            </div>
                        </div>
                    </div>

                    {/* Contact Form */}
                    <div className={`lg:col-span-3 transition-all duration-700 delay-400 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"}`}>
                        <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-8">
                            <h3 className="mb-6 text-xl font-semibold">{t.contact.formHeading}</h3>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="relative">
                                    ...
                                    <label
                                        htmlFor="name"
                                        className={`pointer-events-none absolute left-4 transition-all duration-200 ${focusedField === "name" || formState.name ? "top-2 text-xs text-cyan-400" : "top-1/2 -translate-y-1/2 text-sm text-zinc-500"}`}
                                    >
                                        {t.contact.name}
                                    </label>
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <label
                                        htmlFor="email"
                                        className={`pointer-events-none absolute left-4 transition-all duration-200 ${focusedField === "email" || formState.email ? "top-2 text-xs text-cyan-400" : "top-1/2 -translate-y-1/2 text-sm text-zinc-500"}`}
                                    >
                                        {t.contact.email}
                                    </label>
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <label
                                        htmlFor="message"
                                        className={`pointer-events-none absolute left-4 transition-all duration-200 ${focusedField === "message" || formState.message ? "top-2 text-xs text-cyan-400" : "top-4 text-sm text-zinc-500"}`}
                                    >
                                        {t.contact.message}
                                    </label>
                                </div>
